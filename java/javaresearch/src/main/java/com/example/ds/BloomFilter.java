...
public class BloomFilter implements Cloneable {
	 ...
	 * @param m
	 *            Desired size of the container in bits
	 **/
	...
	/**
	 * Returns true if the element is in the container. Returns false with a
	 * probability ≈ 1-e^(-ln(2)² * m/n) if the element is not in the container.
	 **/
